  ...
  return (
    <div className="md:text-center px-6 md:px-20 text-left mb-12 md:mb-24 py-24 lg:py-48">
      ...
      <div className="content md:w-1/3 mx-auto mb-8">
        {/* Main Title */}
        <h1 className="text-left text-3xl font-medium md:text-7xl mb-4">Glance</h1>
        {/* Frontmatter date as 'Updated:' for consistency */}
        ...
        <p className="text-left mb-4 font-light">
          Glance allows you to have multiple financial accounts in the same place to avoid the redundancy of checking
          multiple platforms. It also provides market information and curated AI insights based on your spending habits
          and investments.
        </p>
        ...
        <h2 className="text-left text-2xl font-medium mb-2">Challenges we ran into</h2>
        <p className="text-left mb-8 font-light">
          Challenges we ran into included attempting to use crypto APIs such as Binance, Coinbase, and Robinhood, which
          proved unfeasible given project scope (cost, time constraints, and the need for a registered business).
        </p>
        ...
        <p className="text-left mb-8 font-light">
          ...
          conflicts, securely implemented OAuth for user logins, and employed a modern stack (T3) despite no prior
        ...
        <p className="text-left mb-8 font-light">
          We learned how powerful frameworks can be for rapidly developing applications from scratch, how to route APIs,
          and that integrating certain APIs can be much harder than others.
        </p>
        ...
        <ul className="list-disc text-left ml-8 mb-8 font-light">
          ...
          <li><code>npm run db:push</code></li>
